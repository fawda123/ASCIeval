...
# create a complete genus column to the traits lookup table
# select only the trait categories used in selected metrics
x <- pmmilkup$traits %>%
  dplyr::select(Phylum, Class, Order, Family, Genus1, FinalIDassigned, Salinity, Motility, BCG, IndicatorClass_TP, IndicatorClass_DOC, Green, TrophicState, ZHR) %>% 
