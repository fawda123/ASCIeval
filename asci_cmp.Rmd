...
opts_chunk$set(message = F, warning = F, fig.path = 'figs/', dev = 'png', dev.args = list(tiff = list(family = 'serif')), dpi = 400, out.width = '70%')
...
# combine
scrs <- rbind(h20_ref, asc_ref)
```

```{r biascmp, fig.height = 5, fig.width = 7}
...
```{r senscmp, fig.height = 5, fig.width = 7}
toplo <- scrs %>% 
